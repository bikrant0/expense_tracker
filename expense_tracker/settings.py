...
SECRET_KEY = 'django-insecure-l_4ykyn^6*#!hc2%x-fxel5d$-#n4oiu&%@!tqikd+7h89p5qj'
...
# Email settings — prints email to terminal during development
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
EMAIL_HOST = 'localhost'
DEFAULT_FROM_EMAIL = 'noreply@expensetracker.com'

# Gmail example (production)
